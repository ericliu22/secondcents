...
//  TwoCents
//
//  Created by jonathan on 9/22/23.
//
...
#Preview {
    FriendRequestsView(showSignInView: .constant(false),loadedColor: .constant(.red),showCreateProfileView: .constant(false), friendsOnly: false, targetUserId: "")
}
